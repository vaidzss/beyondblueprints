...
function Contact() {
  ...
  return (
    <section id="contact">
      <Navbar />
      <motion.div 
      className="img bg-[url('/hero5.png')] bg-cover bg-center h-full">
      ...
      variants={sectionVariant}
            ...
            <div className="p-10 text-white z-50 font-plus">
              ...
              >
                <div className="mt-10">
                  ...
                  <input
                    type="text"
                    className="mt-1 block w-full  h-10 bg-[#210a0b] sm:text-sm"
                  />
                </div>
                <div className="mt-4">
                  <label className="block text-sm font-medium text-white">
                ...
                <div className="mt-4">
                  ...
                  <textarea
                    className="mt-1 block w-full  bg-[#210a0b] sm:text-sm"
                    rows={4}
                  ></textarea>
                </div>
                <button
          ...
          <h4 className="text-base font-libre mb-3 pt-8 ">Also Connect Through:</h4>
